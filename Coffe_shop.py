...
st.markdown(
    ...
    <div style="padding: 10px; border: 2px solid black; border-radius: 10px; background-color: #6F4E37; color: white; width: 100%; max-width: 800px; margin: 0 auto;">
        <h1 style="text-align: center;">☕ Buzz & Beans: Sales Tracker</h1>
...
def main():
    ...
    if page == "🏠 Home":
        ...
        st.markdown(
            """
            <div style="padding: 15px; border: 2px solid black; border-radius: 10px; background-color: #6F4E37; color: white; width: 100%; max-width: 600px; margin: 0 auto;">
                <h1 style="text-align: center; margin-bottom: 10px;">Age Distribution Analysis</h1>
            </div>
            """, 
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            ...
            <div style="padding: 15px; border: 2px solid black; border-radius: 10px; background-color: #6F4E37; color: white; width: 100%; max-width: 800px; margin: 0 auto;">
                <h1 style="text-align: center; margin-bottom: 10px;">Pricing Strategy</h1>
            </div>
            """, 
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            """
            <div style="padding: 15px; border: 2px solid black; border-radius: 10px; background-color: #6F4E37; color: white; width: 100%; max-width: 800px; margin: 0 auto;">
                <h1 style="text-align: center; margin-bottom: 10px;">Future Demand Analysis</h1>
            </div>
            """, 
            unsafe_allow_html=True
        )
